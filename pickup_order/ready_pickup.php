...
<?php
$sql = "SELECT o.order_id, o.status, o.contact_name, o.delivery_date, o.time, o.total_price, e.full_name FROM `tb_order` o LEFT JOIN tb_employee e ON o.delivery_person = e.user_id WHERE o.status = '4' AND O.delivery_person = '$user_id'";
$result = $conn->query($sql);
$result->num_rows;
?>
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                <tr>
                    ...
                    <td><a class="btn btn-primary" href="<?php echo SITE_URL; ?>pickup_order/view_pickup.php?order_id=<?php echo $row['order_id']; ?> && status=<?php echo $row['status']; ?>"><i class="fas fa-eye"></i></a></td>
                </tr>
                <?php
            }
        }
