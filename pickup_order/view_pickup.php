...
<div class="row">
    ...
    <a class = "btn btn-primary order-notify" href = "<?php echo SITE_URL; ?>delivery/on_delivery.php?order_id=<?php echo $orow['order_id']; ?> && status=<?php echo $orow['status']; ?>"><i class="fas fa-truck-loading"></i></a>
</div>
