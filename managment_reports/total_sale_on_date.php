...
$sql = "SELECT date(tb_order.created) AS date, SUM(tb_order_item.item_total) AS amount FROM `tb_order_item` LEFT JOIN tb_order ON tb_order.order_id = tb_order_item.order_id $where GROUP BY date(tb_order.created)";
