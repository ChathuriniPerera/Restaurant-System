...
if (isset($_GET['order_id'])) {
    ...
    $sql = "UPDATE `tb_order` SET `status`=4 WHERE `order_id`=$getorder_id";
...
?>
<div class="row">
    <a type="button" class="btn btn-outline-danger btn-sm" href="detail_kot.php"><i class="fas fa-hand-point-left"></i></a>
