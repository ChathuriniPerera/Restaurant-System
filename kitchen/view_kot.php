...
<div class="row">
    ...
    <a class = "btn btn-primary order-notify" href = "<?php echo SITE_URL; ?>kitchen/processing_kitchen.php?order_id=<?php echo $orow['order_id']; ?>"><i class="fas fa-dumpster-fire"></i></a>
</div>
